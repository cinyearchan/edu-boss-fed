    ...
    <el-form>
      <div v-show="activeStep === 0">
        ...
        <el-form-item label="课程排序">
          <el-input-number label="课程排序" v-model="course.sortNum" />
        </el-form-item>
      </div>
      <div v-show="activeStep === 1">
        ...
        <el-form-item label="解锁封面">
          <course-image :limit="5" v-model="course.courseImgUrl"></course-image>
        </el-form-item>
      </div>
      <div v-show="activeStep === 2">
        ...
        <el-form-item label="活动标签">
          <el-input v-model="course.discountsTag">
            <i class="el-input__icon" slot="suffix">0/4</i>
          </el-input>
        </el-form-item>
      </div>
